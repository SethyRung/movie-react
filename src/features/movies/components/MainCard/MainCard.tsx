...
const MainCard = forwardRef<HTMLDivElement, MainCardProps>(({
  ...
  return (
    <div ref={ref} className="p-2 table:p-4 desktop:pl-6 text-white bg-tertiary-500 rounded-lg flex flex-col lgMobile:flex-row-reverse justify-between gap-4 tablet:gap-8">
