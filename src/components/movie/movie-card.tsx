  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-1">
        <h3 className="text-[15px] leading-5 font-semibold tracking-[-0.26px] group-hover:underline group-hover:underline-offset-4">
          {movie.title}
        </h3>
        {year ? (
          <p className="text-muted-foreground font-mono text-[11px] tracking-[1.1px]">{year}</p>
        ) : null}
      </div>
    </Link>
  );
