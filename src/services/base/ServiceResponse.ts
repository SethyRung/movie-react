...
): response is ServiceResponse<T> & { data: T; error: null; success: true } {
  return response.success === true && response.data !== null && response.error === null;
}

export function isErrorResponse<T>(
  response: ServiceResponse<T>,
): response is ServiceResponse<T> & { data: null; error: ServiceError; success: false } {
...
export function hasError<T>(
  response: ServiceResponse<T>,
): response is ServiceResponse<T> & { error: ServiceError } {
